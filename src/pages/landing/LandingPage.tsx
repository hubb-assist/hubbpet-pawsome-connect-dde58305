        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2">
              <img alt="Veterinário examinando um cachorro" src="/lovable-uploads/41b8159e-27bf-4b1b-b1a3-6547059a1a03.png" className="rounded-lg w-full shadow-lg object-contain" />
            </div>
          </div>
        </div>
      </section>
